...
@Bean
    ...
    public Binding binding(@Qualifier("RecepyForClient") Queue queue,FanoutExchange fanoutExchange,@Qualifier("RecepyForWarehouse") Queue recepyQueu){
    ...
    public Binding bindingTwo(FanoutExchange fanoutExchange,@Qualifier("RecepyForWarehouse") Queue recepyQueu){

        return    BindingBuilder.bind(recepyQueu).to(fanoutExchange);
