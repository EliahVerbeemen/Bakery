...
public class TestController {
    ...
    public TestController(ProductManager productManager, PurchaseOrderProductManager purchaseOrderProductManager, RabbitSender rabbitSender, IngredientManager ingredientManager){
    ...
    @GetMapping("/purchase")
    public List<PurchaseProduct> purchaseproducten(){


        return purchaseOrderProductManager.findAll();
    }
